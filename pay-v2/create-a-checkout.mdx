...
<Tip>
   ...
   Reference.](/v2/api-reference/checkouts/create "API Reference.")
</Tip>
...
```
Which is the [Checkout](/v2/api-reference/checkouts/checkout-object "Checkout") object you just created.  

You can see in the Response a parameter called `url`:
```json
"url": "https://pay.chargily.dz/test/checkouts/01hj5n7cqpaf0mt2d0xx85tgz8/pay"
```
...
You will see now how to make your website or application react to a successful payment using [Webhooks](/v2/webhooks "Webhooks").

<Card title="Receive webhooks" icon="link" href="/v2/create-a-checkout">

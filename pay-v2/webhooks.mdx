...
og:title: Webhooks | Chargily Pay API | Chargily for Developers
---
...
To register your endpoint URL, go to [the Developers Corner page in the Chargily Pay Dashboard](https://pay.chargily.com/dashboard/developers-corner "the Developers Corner in the Chargily Pay Dashboard") and add the URL of your endpoint.

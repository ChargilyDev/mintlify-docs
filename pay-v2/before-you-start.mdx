...
https://pay.chargily.net/test/api/pay-v2
   ...
   <Step title="Secret API Key">
      The secret key should be sent within an Authorization Bearer Header for each request. You can access and manage your API keys on [the Developers Corner page in the Chargily Pay Dashboard](https://pay.chargily.com/dashboard/developers-corner "the Developers Corner in the Chargily Pay Dashboard").
   </Step>
</Steps>

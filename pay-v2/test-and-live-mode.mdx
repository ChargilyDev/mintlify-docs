...
og:title: Test and Live modes | Chargily Pay API | Chargily for Developers
...
<Note>You have to [verify your user account](/pay-v2/account-verification "verify your user account") first to be able to use Live Mode.</Note>

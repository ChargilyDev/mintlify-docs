...
To find your API keys, navigate to [the Developers Corner page in the Chargily Pay Dashboard](https://pay.chargily.com/dashboard/developers-corner "the Developers Corner in the Chargily Pay Dashboard"), you will find the API keys for the current application and selected mode (Test or Live). To view the API keys for the other mode, simply switch to it.

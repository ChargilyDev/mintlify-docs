...
You can start using your Chargily Pay account in [Test Mode](/pay-v2/test-and-live-mode "Test Mode") immediately after creating it. In this mode, you can simulate all of Chargily Pay's features without involving actual funds. To process real payments, you must activate your account and user Live Mode's [API URL and keys.](/pay-v2/api-keys "API URL and keys.")

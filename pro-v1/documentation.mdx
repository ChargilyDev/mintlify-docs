...
description: "Welcome to the API documentation of Chargily Pro™. The easiest way to integrate Mobile Credit Topup service of all telecom operators in Algeria. Add Flexy Djezzy, Arselli Mobilis and Storm Ooredoo into your App, Website or any project."
...
- [Endpoints](#endpoints)
  ...
  - [Topup/Recharge](#topuprecharge-endpoints)
  - [Topup Configuration](#topup-configuration-endpoints)
  - [Vouchers/Cards](#voucherscard-endpoints)
...
- `mode`: Required, valid mode for operator (e.g., "prepaid", "postpaid")
...
**Fields**:
- `mode`: Name of the recharge mode (e.g., "prepaid", "postpaid")
...
### Vouchers/Card Endpoints

#### List All Vouchers/Cards
Returns all available digital vouchers and gift cards.

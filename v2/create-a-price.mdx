...
<Tip>
   ...
   Reference.](/v2/api-reference/prices/create "API Reference.")
</Tip>
...
```
Which is the [Price](/v2/api-reference/prices/price-object "Price") object you just created.  

## Next

Now that you have a Price, you can use it to create a [Checkout](/v2/api-reference/checkouts/checkout-object "Checkout") for your customers to pay.

<Card title="Create a Checkout" icon="credit-card" href="/v2/create-a-checkout">
